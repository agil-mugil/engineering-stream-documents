...
VALUES('TRIBE','RCM','Referntial Client Management','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('FT','SNO','Strcture andtgrouprefdataeng Oraganization','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('FT','ENO','Environmental and Others','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('FT','PNA','Payment and Accounts','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('FT','KYC','Know Your Customer','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('FT','SCOW','SGCIB Client Onboarding team','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('APPLICATION','BDR','Referential System','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);

INSERT INTO `bookmark`.`tgrouprefdataeng`
(`GROUPTYPE`,`GROUPVALUE`,`GROUPVALUEDESC`,`OPECRE`,`DATCRE`,OPEMOD,DATMOD)
VALUES('APPLICATION','MAESTRO','Maestro Application','bookmark',CURRENT_DATE,'bookmark',CURRENT_DATE);
